Feature: uj03_graphical_screen_editing - 2204269_Double_click_behavior
    As a Configuration engineer (Igor / Anna),
    I want to have possibilities to for instantiating the visual elements,
    So that I can make use of the available screen items from toolbox.

    @tc:3629907
    @feature:2204269
    Scenario: Layout UI componets on screen: Add Clock Element
        ...
        When I dismis all notifications
        When I sleep "5" seconds, to make sure
        And the webview "Screen Editor | MyScreen" should look like reference image "01_screen_editor_basic-withtout-2nd-clock" 
        When I double click "Clock" in the bottombar
        Then the webview "Screen Editor | MyScreen" should look like reference image "01_screen_editor_basic-with-2nd-clock"
        ...
        # Second Clock
        Then I should see a "WSI:Clock" with id "HmiClock_550" in the runtime
